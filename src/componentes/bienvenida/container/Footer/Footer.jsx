      ...
      <div className="app__footer-links">
        ...
        <div className="app__footer-links_work">
          ...
          <div className="app__footer-links_icons">
            <a type="button" href="https://github.com/PandArtist93" target="_blank" rel="noreferrer">
              {' '}
              .
              <FiGithub />
            </a>
            <a type="button" href="mailto:maizaga01@gmail.com" target="_blank" rel="noreferrer">
              {' '}
              .
              <FiMessageSquare />
            </a>
            <a type="button" href="https://www.linkedin.com/in/rosamaria-rodriguez-6904a1191/" target="_blank" rel="noreferrer">
              {' '}
              .
              <FiLinkedin />
            </a>
          ...
          <div className="app__footer-links_icons">
            <a type="button" href="https://github.com/RJRCH123" target="_blank" rel="noreferrer">
              {' '}
              .
              <FiGithub />
            </a>
            <a type="button" href="mailto:rous9716@gmail.com" target="_blank" rel="noreferrer">
              {' '}
              .
              <FiMessageSquare />
            </a>
