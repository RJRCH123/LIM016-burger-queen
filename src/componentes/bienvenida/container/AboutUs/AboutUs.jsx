  ...
  <div className="app__aboutus bienvenida__bg flex__center section__padding" id="about">
    ...
    <div className="app__aboutus-content flex__center">
      ...
      <div className="app__aboutus-content_history">
        ...
        <img src={images.spoon} alt="about_spoon" className="spoon__img" />
        <p className="p__opensans">Bienvenido cordial mesero, en Karma estamos encantados por tu gran labor para la comunidad karmática. En esta página encontrarás las siguientes secciones que te ayudarán en nuestro dia a dia: Realizar pedido, pedidos por entregar e historial de pedidos.</p>      </div>
    </div>
  </div>
);
